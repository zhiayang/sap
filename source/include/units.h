...
namespace dim
{
	...
	*/
	...
	struct Scalar
	{
		...
		constexpr self_type& operator+= (self_type ofs) { this->_x += ofs._x; return *this; }
		constexpr self_type& operator-= (self_type ofs) { this->_x -= ofs._x; return *this; }
		constexpr self_type& operator*= (value_type scale) { this->_x *= scale; return *this; }
		constexpr self_type& operator/= (value_type scale) { this->_x /= scale; return *this; }
	...
	struct Vector2
	{
		...
		constexpr self_type& operator+= (self_type ofs) { this->_x += ofs._x; this->_y += ofs._y; return *this; }
		constexpr self_type& operator-= (self_type ofs) { this->_x -= ofs._x; this->_y -= ofs._y; return *this; }
	...
	namespace units
	{
		...
		*/
		struct base_unit    { static constexpr double scale_factor = 1.0; };
	}
}
...
#define DEFINE_UNIT(_unit_name, _SF)                                                            \
	namespace dim::units { struct _unit_name { static constexpr double scale_factor = _SF; }; } \
	namespace dim                                                                               \
	{                                                                                           \
